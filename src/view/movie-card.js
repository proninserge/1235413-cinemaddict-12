...
import {SymbolCount} from '../constants';
...
const getDescription = (description) => {
  if (description.length < SymbolCount.MAX) {
    return description;
  }

  return `${description.substring(SymbolCount.MIN, SymbolCount.MAX)}...`;
};
  ...
  return (
    `<article class="film-card">
       ...
       <p class="film-card__info">
         ...
         <span class="film-card__genre">${genres[GENRE_MAIN] ? genres[GENRE_MAIN] : ``}</span>
       </p>
